...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIColor *textColor = [UIColor colorWithRed:0.000 green:0.502 blue:0.000 alpha:1.000];
    ...
    [cell.textLabel setFont:[UIFont fontWithName:@"Noteworthy-Light" size:cell.textLabel.font.pointSize]];
    return cell;
}
